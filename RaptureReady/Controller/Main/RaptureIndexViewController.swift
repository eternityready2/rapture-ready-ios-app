//
//  RaptureIndexViewController.swift
//  RaptureReady
//
...
class RaptureIndexViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        webView.load(SiteURLs.RaptureIndex)
...
extension RaptureIndexViewController: WKUIDelegate, WKNavigationDelegate {
